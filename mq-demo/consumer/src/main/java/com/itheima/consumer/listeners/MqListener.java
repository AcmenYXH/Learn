...
public class MqListener {
    ...
    public void listenFanoutDirectQueue1(String msg) throws InterruptedException {
        System.out.println("消费者1 收到了 direct.queue1的消息：【" + msg +"】");
    }

    @RabbitListener(queues = "direct.queue2")
    public void listenFanoutDirectQueue2(String msg) throws InterruptedException {
